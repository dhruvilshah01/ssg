...
def generate_pages_recursive(dir_path_content, template_path, dest_dir_path):
    ...
    for directory in dir_list:
        ...
        if(os.path.isfile(curr_content_path)):
            ...
            #call generate page
            generate_page(curr_content_path,template_path,curr_dir_path)
        #it is a directory
        else:
            curr_dir_path = os.path.join(dest_dir_path, directory)
            os.mkdir(curr_dir_path)
            generate_pages_recursive(curr_content_path, template_path, curr_dir_path)
    return
...
def copy_static_files():
    ...
    os.makedirs("./public")
    copy_static_files_helper("./static","./public")
